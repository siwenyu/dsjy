      ...
      <div className="erji about">
        ...
        <div className="right">
          ...
          <div className="aboutus">
            ...
            <div className="title14 gap-bottom-m gap-top-m">
              理念：学生为本、市场为准、服务为训
              <br />
              愿景：让学生幸福就业，让单位满意而归
            </div>
            ...
            <div className="title16 gap-bottom-s">部门设置</div>
              ...
              <div className="shezhi-text">
                {
                  shezhiList.map(e => {
                    return <div className="gap-top-m shezhi-item">
                      <div className="title14 gap-bottom-m">{e.title}</div>
                      <div>{e.text}</div>
                    </div>
                  })
                }
            ...
            <div className="normal-row">
              ...
              <div className="normal-col">
                <div className="title14 gap-bottom-s">标识释义</div>
                <br />
                <div>
              ...
              <Tabs defaultActiveKey="1">
                <TabPane tab="本部校区" key="1">
                  <div className="map-item inner-top-m">
                    <img src={mapImg1} alt="" />
                    <div className="map-text title16">
