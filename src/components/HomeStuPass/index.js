...
export default function HomeStuPass({
  // tabData
}) {
  ...
  return (
    <div className="home-stu-pass normal-card">
        ...
        <div className="pass-line2">
          ...
          </div> */}
          {
            passData.map((item, indexIndex) => {
              return (
                <div style={{ backgroundColor: item.bgColor }} onClick={() => handleToolClick(item)} key={item.title} className="pass-item">
